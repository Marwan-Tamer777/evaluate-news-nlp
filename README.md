project subbmission for Evaluate a news article with Natural Language Processing (NPL).
...
multiple config files and main index.js file.

2 webpack configs for development and prodcution.
...
the main file in this project is the server labaled index.js in the server file and formHandler.js in the client js side.
